...
description: Reference map for Firstmate operational-home files and runtime artifacts; load only through the inline section 2 trigger.
...
The following inventory is the detailed operational-home map extracted from `AGENTS.md`.
