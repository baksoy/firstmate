...
| `fm-upstream-sync-check.sh` | Daily OS-scheduled sync of this fork's main from `upstream/main`: merges and pushes when conflict-free, otherwise makes no changes and fires a durable wake naming the conflict |
