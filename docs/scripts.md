...
| `fm-procevent-agentmail.sh` | Wake firstmate over AgentMail's push WebSocket the instant new inbound email lands in an inbox, self-announcing straight to the durable wake queue |
